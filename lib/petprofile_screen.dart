  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: _selectedIndex == 0
        ...
        elevation: 0,
        title: Text('Pet Profile', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
        actions: [
          IconButton(
      ...
      body: IndexedStack(
        ...
        children: [
          ...
          PetHealthScreen(), // PetHealthScreen
          NutritionPage(), // NutritionPage
          ExerciseMonitoringPage(), // ExerciseMonitoringPage
          GroomingPage(), // GroomingPage
        ],
      ),
